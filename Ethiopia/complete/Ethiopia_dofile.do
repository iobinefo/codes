...
heckman real_tpricefert_cens_mrk dist_admarc_w real_maize_price_mr real_rice_price_mr lland_holding informal_save formal_credit informal_credit ext_acess  attend_sch hh_headage femhead num_mem safety_net  lreal_hhvalue  worker org_fert  i.year, select (commercial_dummy= dist_admarc_w real_maize_price_mr real_rice_price_mr informal_save formal_credit informal_credit lland_holding ext_acess  attend_sch hh_headage femhead num_mem safety_net  lreal_hhvalue  worker org_fert soil_qty_rev2  i.year) twostep
predict yhat, xb
...
** CRE-TOBIT 
tobit ltotal_qty_w lyhat dist_admarc_w real_maize_price_mr real_rice_price_mr ext_acess attend_sch femhead safety_net lland_holding lreal_hhvalue hh_headage  num_mem  worker formal_credit informal_credit org_fert  annual_mean_temp annual_precipitation              TAvg_ltotal_qty_w TAvg_lyhat TAvg_dist_admarc_w TAvg_real_maize_price_mr TAvg_real_rice_price_mr TAvg_ext_acess TAvg_attend_sch TAvg_femhead TAvg_safety_net TAvg_lland_holding TAvg_lreal_hhvalue TAvg_hh_headage  TAvg_num_mem TAvg_annual_mean_temp TAvg_annual_precipitation TAvg_worker TAvg_formal_credit TAvg_informal_credit TAvg_org_fert i.year, ll(0)
...
** CRE-TOBIT 
tobit total_qty_w yhat dist_admarc_w real_maize_price_mr real_rice_price_mr ext_acess attend_sch femhead safety_net lland_holding lreal_hhvalue hh_headage  num_mem  worker formal_credit informal_credit org_fert  annual_mean_temp annual_precipitation              TAvg_total_qty_w TAvg_yhat TAvg_dist_admarc_w TAvg_real_maize_price_mr TAvg_real_rice_price_mr TAvg_ext_acess TAvg_attend_sch TAvg_femhead TAvg_safety_net TAvg_lland_holding TAvg_lreal_hhvalue TAvg_hh_headage  TAvg_num_mem TAvg_annual_mean_temp TAvg_annual_precipitation TAvg_worker TAvg_formal_credit TAvg_informal_credit TAvg_org_fert i.year, ll(0)
...
** CRE-TOBIT
 preserve 
heckman real_tpricefert_cens_mrk dist_admarc_w real_maize_price_mr real_rice_price_mr lland_holding informal_save  formal_credit informal_credit ext_acess  attend_sch hh_headage femhead num_mem safety_net  lreal_hhvalue worker  i.year, select (commercial_dummy= dist_admarc_w real_maize_price_mr real_rice_price_mr informal_save  formal_credit informal_credit lland_holding ext_acess  attend_sch hh_headage femhead num_mem safety_net  lreal_hhvalue  worker org_fert soil_qty_rev2  i.year) twostep 
predict yhat, xb
