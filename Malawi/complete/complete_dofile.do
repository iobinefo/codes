log using "C:\Users\obine\Music\Documents\Project\codes\Malawi_log_file.smcl", append
**********************************************

*Heckman Log
use "C:\Users\obine\Music\Documents\Project\codes\Malawi\Heckman\complete\Real_heckmanp.dta", clear
use "C:\Users\obine\Music\Documents\Project\codes\Malawi\Heckman\complete\Nominal_heckmanp.dta", clear
...
** CRE-TOBIT
 preserve 
heckman real_tpricefert_cens_mrk  subsidy_qty_w dist_admarc_w maize_price_mr lland_holding lhhasset_value_w org_fert hh_headage_mrk attend_sch femhead num_mem  i.year, select (commercial_dummy=  subsidy_qty_w dist_admarc_w maize_price_mr lland_holding lhhasset_value_w org_fert hh_headage_mrk attend_sch femhead num_mem good fair  i.year) twostep
predict yhat, xb
predict inm, mills
...
bootstrap, reps(50) seed(123) cluster(HHID) idcluster(newid): myboot
...
** CRE-TOBIT 
tobit total_qty_w yhat_w subsidy_qty_w dist_admarc_w maize_price_mr lland_holding lhhasset_value_w org_fert hh_headage_mrk attend_sch femhead num_mem       TAvg_total_qty_w TAvg_yhat_w TAvg_subsidy_qty_w TAvg_dist_admarc_w TAvg_maize_price_mr TAvg_lland_holding TAvg_lhhasset_value_w  TAvg_org_fert TAvg_hh_headage_mrk  TAvg_attend_sch TAvg_femhead TAvg_num_mem inm i.year, ll(0)
margins, predict(ystar(0,.)) dydx(*) post
restore
end
bootstrap, reps(100) seed(123) cluster(HHID) idcluster(newid): myboot

tabstat total_qty_w subsidy_qty_w  yhat yhat_w num_mem hh_headage  [aweight = weight], statistics( mean median sd min max ) columns(statistics)
...
** CRE-TOBIT 
xtreg ltotal_qty_w lyhat subsidy_qty_w dist_admarc_w maize_price_mr lland_holding lhhasset_value_w org_fert hh_headage_mrk attend_sch femhead num_mem inm i.year,  fe i(HHID)
restore
end
bootstrap, reps(100) seed(123) cluster(HHID) idcluster(newid): myboot
...
** CRE-TOBIT 
xtreg total_qty_w yhat subsidy_qty_w dist_admarc_w maize_price_mr lland_holding lhhasset_value_w org_fert hh_headage_mrk attend_sch femhead num_mem inm i.year,  fe i(HHID)
restore
end
bootstrap, reps(100) seed(123) cluster(HHID) idcluster(newid): myboot
...
xtreg ltotal_qty_w lreal_tpricefert_cens_mrk subsidy_qty_w dist_admarc_w maize_price_mr lland_holding lhhasset_value_w org_fert hh_headage_mrk attend_sch femhead num_mem i.region i.year, fe i(HHID) cluster(HHID)

** OLS with HH fixed effects
xtreg total_qty_w real_tpricefert_cens_mrk subsidy_qty_w dist_admarc_w maize_price_mr lland_holding lhhasset_value_w org_fert hh_headage_mrk attend_sch femhead num_mem i.region i.year, fe i(HHID) cluster(HHID)
...
** CRE-TOBIT
preserve 
tobit total_qty_w real_tpricefert_cens_mrk subsidy_qty_w dist_admarc_w maize_price_mr lland_holding lhhasset_value_w org_fert hh_headage_mrk attend_sch femhead num_mem       TAvg_total_qty_w TAvg_real_tpricefert_cens_mrk TAvg_subsidy_qty_w TAvg_dist_admarc_w TAvg_maize_price_mr TAvg_lland_holding TAvg_lhhasset_value_w  TAvg_org_fert TAvg_hh_headage_mrk  TAvg_attend_sch TAvg_femhead TAvg_num_mem i.year, ll(0)
margins, predict(ystar(0,.)) dydx(*) post
restore
end
bootstrap, reps(100) seed(123) cluster(HHID) idcluster(newid): myboot
...
** CRE-TOBIT
 preserve 
tobit ltotal_qty_w lreal_tpricefert_cens_mrk subsidy_qty_w dist_admarc_w maize_price_mr lland_holding lhhasset_value_w org_fert hh_headage_mrk attend_sch femhead num_mem       TAvg_ltotal_qty_w TAvg_lreal_tpricefert_cens_mrk TAvg_subsidy_qty_w TAvg_dist_admarc_w TAvg_maize_price_mr TAvg_lland_holding TAvg_lhhasset_value_w  TAvg_org_fert TAvg_hh_headage_mrk  TAvg_attend_sch TAvg_femhead TAvg_num_mem i.year, ll(0)
