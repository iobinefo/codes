...
use "${Uganda_GHS_W4_raw_data}\GSEC11A.dta",clear 
GSEC11B
...
use "${Uganda_GHS_W4_raw_data}\GSEC15c.dta", clear

use "${Uganda_GHS_W4_raw_data}\GSEC15d.dta", clear
...
save "${Uganda_GHS_W4_created_data}\food_prices.dta", replace
...
***************
use "${Uganda_GHS_W4_raw_data}/GSEC15.dta", clear
use "${Uganda_GHS_W4_raw_data}/GSEC15C.dta", clear
...
misstable summarize femhead  ext_acess attend_sch    total_qty_w  real_tpricefert_cens_mrk num_mem hh_headage real_hhvalue worker land_holding soil_qty_rev2 mrk_dist_w
...
use "C:\Users\obine\Music\Documents\Project\codes\Uganda\Uganda_wave4\Uganda_wave44_complete_data.dta" ,clear
...
save "C:\Users\obine\Music\Documents\Project\codes\Uganda\Real_Price_median.dta", replace
