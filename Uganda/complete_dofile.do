...
local time_avg "total_qty_w mrk_dist_w real_tpricefert_cens_mrk num_mem hh_headage real_hhvalue worker land_holding femhead  ext_acess attend_sch soil_qty_rev2"
...
heckman real_tpricefert_cens_mrk  land_holding ext_acess attend_sch  i.year, select (commercial_dummy= mrk_dist_w num_mem hh_headage real_hhvalue worker land_holding femhead ext_acess attend_sch soil_qty_rev2  i.region i.year) twostep
...
** CRE-TOBIT 
tobit total_qty_w mrk_dist_w yhat num_mem hh_headage real_hhvalue worker land_holding femhead ext_acess attend_sch soil_qty_rev2 TAvg_total_qty_w TAvg_mrk_dist_w TAvg_yhat TAvg_num_mem TAvg_hh_headage TAvg_real_hhvalue TAvg_worker TAvg_land_holding TAvg_femhead TAvg_ext_acess TAvg_attend_sch  TAvg_soil_qty_rev2 i.region i.year, ll(0)
...
** CRE-TOBIT 
tobit total_qty_w mrk_dist_w real_tpricefert_cens_mrk num_mem hh_headage real_hhvalue worker land_holding femhead ext_acess attend_sch  soil_qty_rev2 TAvg_total_qty_w TAvg_mrk_dist_w TAvg_real_tpricefert_cens_mrk TAvg_num_mem TAvg_hh_headage TAvg_real_hhvalue TAvg_worker TAvg_land_holding TAvg_femhead TAvg_ext_acess TAvg_attend_sch TAvg_soil_qty_rev2  i.year, ll(0)
