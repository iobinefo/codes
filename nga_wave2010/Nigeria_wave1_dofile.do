...
global Nigeria_GHS_W1_created_data  "C:\Users\obine\Music\Documents\Project\codes\nga_wave2010"
...
use "C:\Users\obine\Music\Documents\Smallholder lsms STATA\NGA_2010_GHSP-W1_v03_M_STATA (1)\Post Planting Wave 1\Agriculture\sect11e_plantingw1.dta" , clear
*merge m:1 hhid using "${Nigeria_GHS_W1_created_data}/ag_rainy_10.dta", gen(filter)

*keep if ag_rainy_10==1

gen maize_10 = 1 if s11eq2==1080
replace maize_10=0 if maize_10 ==.

tab maize_10
collapse (max)  maize_10, by (hhid)



save  "${Nigeria_GHS_W1_created_data}/maize_10.dta", replace
...
merge m:1 hhid using "${Nigeria_GHS_W1_created_data}/maize_10.dta", gen(maize)
...
misstable summarize subsidy_dummy femhead informal_save formal_credit informal_credit ext_acess attend_sch pry_edu finish_pry finish_sec safety_net net_seller net_buyer total_qty_w subsidy_qty_w mrk_dist_w real_tpricefert_cens_mrk num_mem hh_headage real_hhvalue worker real_maize_price_mr real_rice_price_mr land_holding
