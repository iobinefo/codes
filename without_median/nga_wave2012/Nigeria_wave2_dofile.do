...
global Nigeria_GHS_W2_created_data  "C:\Users\obine\Music\Documents\Project\codes\without_median\nga_wave2012"
...
keep if ag_rainy_12==1
 ...
 tab seed_dummy
save "${Nigeria_GHS_W2_created_data}\seed.dta", replace
...
drop _merge
sort hhid
merge 1:1 hhid using "${Nigeria_GHS_W2_created_data}\seed.dta"
drop _merge
sort hhid
...
save "${Nigeria_GHS_W2_created_data}\Nigeria_wave2_complete_datapn.dta", replace
