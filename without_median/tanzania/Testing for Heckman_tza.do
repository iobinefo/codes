...
** CRE-TOBIT
 preserve 
heckman real_tpricefert_cens_mrk subsidy_qty_w dist_cens_w  real_maize_price_mr  field_size_ha_w org_fert i.year, select (commercial_dummy= subsidy_qty_w dist_cens_w  real_maize_price_mr  field_size_ha_w org_fert good_soil fair_soil  i.year) twostep
predict yhat, xb
predict imr, mills
...
** CRE-TOBIT 
tobit ltotal_qty_w lyhat subsidy_qty_w dist_cens_w  real_maize_price_mr  field_size_ha_w org_fert imr  TAvg_ltotal_qty_w TAvg_lyhat TAvg_subsidy_qty_w TAvg_dist_cens_w TAvg_real_maize_price_mr  TAvg_real_hhvalue  TAvg_org_fert  i.year, ll(0)
...
** CRE-TOBIT
 preserve 
heckman real_tpricefert_cens_mrk subsidy_qty_w dist_cens_w  real_maize_price_mr  field_size_ha_w org_fert i.year, select (commercial_dummy= subsidy_qty_w dist_cens_w  real_maize_price_mr  lfield_size_ha_w org_fert good_soil fair_soil  i.year) twostep
predict yhat, xb
predict imr, mills
...
** CRE-TOBIT 
tobit total_qty_w yhat_w subsidy_qty_w dist_cens_w  real_maize_price_mr  field_size_ha_w org_fert imr  TAvg_total_qty_w TAvg_yhat_w TAvg_subsidy_qty_w TAvg_dist_cens_w TAvg_real_maize_price_mr   TAvg_lfield_size_ha_w TAvg_org_fert  i.year, ll(0)
margins, predict(ystar(0,.)) dydx(*) post
restore
end
bootstrap, reps(100) seed(123) cluster(UPHI) idcluster(newid): myboot
...
** CRE-TOBIT 
xtreg ltotal_qty_w lyhat subsidy_qty_w dist_cens_w  real_maize_price_mr real_hhvalue field_size_ha_w hh_headage_mrk  org_fert attend_sch femhead num_mem imr i.year, fe i(UPHI)
restore
end
bootstrap, reps(100) seed(123) cluster(UPHI) idcluster(newid): myboot
...
** CRE-TOBIT 
xtreg total_qty_w yhat subsidy_qty_w dist_cens_w  real_maize_price_mr real_hhvalue field_size_ha_w hh_headage_mrk  org_fert attend_sch femhead num_mem imr  i.year, fe i(UPHI)
restore
end
bootstrap, reps(100) seed(123) cluster(UPHI) idcluster(newid): myboot
...
xtreg ltotal_qty_w lreal_tpricefert_cens_mrk subsidy_qty_w dist_cens_w  real_maize_price_mr real_hhvalue field_size_ha_w hh_headage_mrk  org_fert attend_sch femhead num_mem i.year, fe i(UPHI) cluster(UPHI)

** OLS with HH fixed effects
xtreg total_qty_w real_tpricefert_cens_mrk subsidy_qty_w dist_cens_w  real_maize_price_mr real_hhvalue field_size_ha_w hh_headage_mrk  org_fert attend_sch femhead num_mem i.year, fe i(UPHI) cluster(UPHI)
...
** CRE-TOBIT
preserve 
tobit total_qty_w real_tpricefert_cens_mrk subsidy_qty_w dist_cens_w  real_maize_price_mr real_hhvalue field_size_ha_w hh_headage_mrk  org_fert attend_sch femhead num_mem  TAvg_total_qty_w TAvg_real_tpricefert_cens_mrk TAvg_subsidy_qty_w TAvg_dist_cens_w TAvg_real_maize_price_mr  TAvg_real_hhvalue TAvg_field_size_ha_w TAvg_hh_headage_mrk TAvg_org_fert TAvg_attend_sch  TAvg_femhead TAvg_num_mem   i.year, ll(0)
margins, predict(ystar(0,.)) dydx(*) post
...
** CRE-TOBIT
 preserve  
tobit ltotal_qty_w lreal_tpricefert_cens_mrk subsidy_qty_w dist_cens_w  real_maize_price_mr real_hhvalue field_size_ha_w hh_headage_mrk  org_fert attend_sch femhead num_mem  TAvg_ltotal_qty_w TAvg_lreal_tpricefert_cens_mrk TAvg_subsidy_qty_w TAvg_dist_cens_w TAvg_real_maize_price_mr  TAvg_real_hhvalue TAvg_field_size_ha_w TAvg_hh_headage_mrk TAvg_org_fert TAvg_attend_sch  TAvg_femhead TAvg_num_mem   i.year, ll(0)
margins, predict(ystar(0,.)) dydx(*) post
restore
end
bootstrap, reps(100) seed(123) cluster(hhid) idcluster(newid): myboot
