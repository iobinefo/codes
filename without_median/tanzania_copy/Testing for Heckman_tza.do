...
**********************************************
*Heckman*
use "C:\Users\obine\Music\Documents\Project\codes\without_median\tanzania\Real_panel5.dta", clear
use "C:\Users\obine\Music\Documents\Project\codes\without_median\tanzania\Nominal_panel5.dta", clear



tabstat total_qty_w subsidy_qty_w dist_cens_w real_tpricefert_cens_mrk real_tpricefert_cens_mrk2 num_mem hh_headage_mrk worker real_maize_price_mr real_rice_price_mr real_hhvalue real_hhvalue2 field_size_ha_w [aweight = weight], statistics( mean median sd min max ) columns(statistics)
...
local time_avg "total_qty_w subsidy_qty_w dist_cens_w real_tpricefert_cens_mrk  real_tpricefert_cens_mrk2 num_mem hh_headage_mrk real_hhvalue real_hhvalue2 worker real_maize_price_mr real_rice_price_mr  field_size_ha_w  subsidy_dummy femhead formal_save formal_bank formal_credit ext_acess attend_sch pry_edu finish_pry finish_sec safety_net net_seller net_buyer soil_qty_rev2 lfield_size_ha_w lreal_hhvalue org_fert"
