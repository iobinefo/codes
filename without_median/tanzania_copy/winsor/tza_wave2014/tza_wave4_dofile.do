...
global tza_GHS_W4_created_data  "C:\Users\obine\Music\Documents\Project\codes\without_median\tanzania_copy\winsor\tza_wave2014"
...
gen rea_tpricefert_cens_mrk2 = tpricefert_cens_mrk_w  /0.7730376
...
replace informal_credit =0 if informal_credit ==.
 ...
 use "${tza_GHS_W4_raw_data}\hh_filters.dta",clear 
merge m:1 y4_hhid using "${tza_GHS_W4_created_data}\ag_rainy_14.dta", gen(filter)
...
merge m:1 HHID using "${tza_GHS_W4_created_data}\tanzania_wave4_completedata_2014.dta", gen(file)
